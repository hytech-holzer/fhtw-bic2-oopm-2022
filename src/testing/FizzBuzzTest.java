...
public class FizzBuzzTest {
    ...
    static List<String> expectedValue(int i) {
        return Arrays.asList("1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", "Fizz", "Buzz", "11", "Fizz", "13", "14",
                ...
                "Fizz", "94", "Buzz", "Fizz", "97", "98", "Fizz", "Buzz").subList(0, i);
    }
